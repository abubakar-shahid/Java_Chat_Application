...
public class SentMessages extends JFrame implements ActionListener {
    ...
    public void showSentMessages(Connection conn, String username) throws SQLException {
        connection = conn;
        name = username;
        model = new DefaultTableModel();
        String[] columns = {"Date", "Sent To", "Message"};
        ...
        setVisible(true);
        setSize(500, 600);
        addWindowListener(new SentMessages.MyWindowListener());
